...
| When | Post | Channels |
| --- | --- | --- |
| T−3 d | Teaser (thesis, no link) | X, Bluesky, LinkedIn |
| T0 | Launch (vertical demo + store links) | all six |
| T+2 d | How-to thread (landscape demo, step by step) | X, Bluesky |
| T+5 d | Privacy + open-source post ({REPO}) | LinkedIn, Facebook, X |
| T+9 d | The essay: "selection is the higher-bandwidth input" | LinkedIn, X thread, Bluesky |

## T−3 · Teaser

**X / Bluesky (≤280/300)**
> Current AI interfaces assume the main thing a human does is prompt. For serious thinking it may increasingly be *selection*: this matters, this doesn't, connect these three, challenge that one. We built something small for that. Thursday.

**LinkedIn**
> Every AI chat interface is built around one verb: prompt. But when I actually think with a model, most of my effort is editorial — reading a long answer and deciding which three sentences deserve a second look. That step has no UI. Copy, paste, retype. We've been building a very small tool for it under Project Nothing. More on Thursday.
...
>
> Private by design: no account, no server, no analytics. Fragments live in your browser, per conversation. Open source under MIT.
>
> Firefox (desktop and Android): {AMO} · Chrome: {CWS} · everything else: {SITE}
